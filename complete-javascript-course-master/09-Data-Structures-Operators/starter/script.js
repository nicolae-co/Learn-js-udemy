...
console.log(new Set('cojocarunicolae').size);
...
const capitalization = function (passager) {
  const passagerLower = passager.toLowerCase();
  const passagerCorrect =
    passagerLower[0].toUpperCase() + passagerLower.slice(1);
  console.log(passagerCorrect);
};
capitalization('iasMSNSI');
...
const announcement = 'All pasagers come to boarding door 23. Boarding door 23';
...
checkBaggage('Got some snacks and a gun for protectiom');
...
capitalizeName('nicolae cojocaru');
...
console.log(maskCreditCard(4323847518365243));
